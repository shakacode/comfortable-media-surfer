  ...
  Redactor.fn = $.Redactor.prototype = {
      ...
      return {
        onSet: function (html) {
          ...
          html = html.replace(
            ...
            '<pre class="redactor-script-tag" style="display: none;" $1>$2</pre>'
          );
        ...
        onSync: function (html) {
          ...
          html = html.replace(
            /<pre class="redactor-script-tag" style="display: none;"(.*?[^>]?)>([\w\W]*?)<\/pre>/gi,
            "<script$1>$2</script>"
          );
          ...
          if (
            ...
            $div.find("p[style]").each(function () {
              ...
              if (matches) {
                ...
                if (
                  currentLevel == 1 &&
                  $.inArray(currentList, listsIds) == -1
                ) {
                  var $list = $("<" + listType + "/>")
                    .attr({
        ...
        isSingleLine: function (html, setMode) {
          ...
          if (!this.utils.isSelectAll() && typeof setMode == "undefined") {
            var blocks = this.opts.blockLevelElements
              .join("|")
              .replace("P|", "")
              .replace("DIV|", "");

            var matchBlocks = html.match(
              new RegExp("</(" + blocks + ")>", "gi")
            );
            ...
            if (
              ...
              (matchContainers === null ||
                (matchContainers && matchContainers.length <= 1))
            ) {
        ...
        restoreSelectionMarker: function (html) {
          html = html.replace(
            /&lt;span id=&quot;selection-marker-([0-9])&quot; class=&quot;redactor-selection-marker&quot; data-verified=&quot;redactor&quot;&gt;​&lt;\/span&gt;/g,
        ...
        normalizeLists: function () {
          this.$editor.find("li").each(function (i, s) {
            ...
            if (
              $next.length !== 0 &&
              ($next[0].tagName == "UL" || $next[0].tagName == "OL")
            ) {
              $(s).append($next);
            }
          });
    ...
    code: function () {
      return {
        set: function (html) {
          ...
          if (this.utils.browser("msie")) {
            html = html.replace(
              /<span(.*?)id="selection-marker-(1|2)"(.*?)><\/span>/gi,
              ""
            );
          }
        ...
        startSync: function () {
          ...
          if (
            (this.code.syncCode && this.code.syncCode == html) ||
            (this.start && html == "")
          ) {
            // do not sync
            return;
        ...
        showCode: function () {
          ...
          var $editorDiv = $("<div/>").append(
            $.parseHTML(this.clean.onSync(this.$editor.html()), document, true)
          );
          ...
          if ($selectionMarkers.length > 0) {
            var editorHtml = this.tabifier
              .get($editorDiv.html())
              .replace(/&amp;/g, "&");

            if ($selectionMarkers.length == 1) {
              start = this.utils.strpos(
                editorHtml,
            ...
            this.$textarea.next(".CodeMirror").each(function (i, el) {
              ...
              if (start == end) {
                el.CodeMirror.setCursor(
                  el.CodeMirror.posFromIndex(start).line,
                  el.CodeMirror.posFromIndex(end).ch
                );
              } else {
        ...
        showVisual: function () {
          ...
          if (end > start) {
            var markerLength = this.selection
              .getMarkerAsHtml(1)
              .toString().length;

            html =
              html.substr(0, end + markerLength) +
              this.selection.getMarkerAsHtml(2) +
              html.substr(end + markerLength);
          }
        ...
        textareaIndenting: function (e) {
          ...
          $el.val(
            $el.val().substring(0, start) +
              "\t" +
              $el.val().substring($el.get(0).selectionEnd)
          );
        ...
        setCallback: function (type, e, data) {
          ...
          if (this.$textarea) {
            ...
            if (
              ...
              typeof events[eventName] != "undefined"
            ) {
              $.each(
                events[eventName],
                  ...
                  if (value["namespace"] == eventNamespace) {
                    ...
                    returnValue =
                      typeof data == "undefined"
                        ? value.handler.call(this, e)
                        : value.handler.call(this, e, data);
                  }
                }, this)
              );
            }
    ...
    dropdown: function () {
      return {
        build: function (name, $dropdown, dropdownObject) {
          ...
          $.each(
            dropdownObject,
            $.proxy(function (btnName, btnObject) {
              var $item = $(
        ...
        show: function (e, key) {
          ...
          if ($button.hasClass("dropact")) {
            ...
            if (this.$toolbar.hasClass("toolbar-fixed-box")) {
              ...
              $dropdown
                .css({ position: position, left: left, top: top + "px" })
                .show();
            } else {
        ...
        hideAll: function () {
          ...
          $(".redactor-dropdown-link-selected").removeClass(
        ...
        hide: function (e) {
          ...
          if (
            !$dropdown.hasClass("dropact") &&
            !$dropdown.hasClass("redactor-dropdown-link-inactive")
          ) {
    ...
    focus: function () {
      return {
        setStart: function () {
          ...
          if (
            this.opts.linebreaks &&
            !this.utils.isBlockTag(first[0].tagName)
          ) {
            this.selection.get();
            this.range.setStart(this.$editor[0], 0);
            this.range.setEnd(this.$editor[0], 0);
    ...
    image: function () {
      return {
        ...
        showEdit: function ($image) {
          ...
          this.image.buttonDelete = this.modal.createDeleteButton(
            this.lang.get("_delete")
          );
          ...
          if (!this.opts.imagePosition)
            ...
            var floatValue =
              $image.css("display") == "block" && $image.css("float") == "none"
                ? "center"
                : $image.css("float");
        ...
        setEditable: function ($image) {
          ...
          $image
            ...
            .on("mousedown.redactor", $.proxy(this.image.hideResize, this));
          $image
        ...
        hideResize: function (e) {
          if (
            e &&
            $(e.target).closest("#redactor-image-box", this.$editor[0])
              .length !== 0
          )
            return;
        ...
        insert: function (json, direct, e) {
          ...
          var $image = this.$editor
            .find("img[data-redactor-inserted-image=true]")
            .removeAttr("data-redactor-inserted-image");
        ...
        increaseBlocks: function () {
          $.each(
            ...
            $.proxy(function (i, elem) {
              ...
              var left =
                this.utils.normalize($el.css("margin-left")) +
    ...
    inline: function () {
      return {
        ...
        formatCollapsed: function (tag) {
          ...
          if (
            $parent.length !== 0 &&
            this.inline.type != "style" &&
            $parent[0].tagName != "SPAN"
          ) {
            // remove empty
        ...
        formatConvert: function (tag) {
          ...
          this.$editor
            .find('[data-redactor-tag="' + tag + '"]' + find)
            .each(function () {
              if (
                find === "" &&
                tag == "span" &&
                this.tagName.toLowerCase() == tag
              )
                return;
        ...
        removeStyle: function () {
          ...
          $.each(
            ...
            $.proxy(function (i, s) {
              var $s = $(s);
              if (
                $.inArray(s.tagName.toLowerCase(), this.opts.inlineTags) !=
                  -1 &&
    ...
    keydown: function () {
      return {
        init: function (e) {
          ...
          if (
            this.opts.enterKey &&
            (this.utils.browser("msie") || this.utils.browser("mozilla")) &&
            (key === this.keyCode.DOWN || key === this.keyCode.RIGHT)
          ) {
          ...
          if (
            ...
            if (
              ...
              this.keydown.exitFromBlockquote(e) === true
            ) {
              return false;
            }
            ...
            if (this.keydown.pre) {
              ...
              if ($next.length !== 0 && $next[0].tagName == "BR") {
                ...
                current !== false &&
                $(current).hasClass("redactor-invisible-space")
              ) {
            ...
            // paragraphs
              ...
              if (this.keydown.block.tagName === "LI") {
                ...
                if (
                  ...
                  $list.next().length === 0 &&
                  this.utils.isEmpty($list.find("li").last().html())
                ) {
        ...
        checkEvents: function (arrow, key) {
          if (
            !arrow &&
            (this.core.getEvent() == "click" || this.core.getEvent() == "arrow")
          ) {
        ...
        setupBuffer: function (e, key) {
          ...
          // undo
            ...
            if (
              ...
              (key == this.keyCode.ENTER && !e.ctrlKey && !e.shiftKey)
            ) {
              this.buffer.set();
            }
          }
        ...
        replaceDivToBreakLine: function () {
          ...
          if (
            ...
            blockHtml === "" &&
            !$(blockElem).hasClass("redactor-editor")
          ) {
        ...
        replaceDivToParagraph: function () {
          ...
          var blockHtml = blockElem.innerHTML.replace(/<br\s?\/?>/gi, "");
          if (
            blockElem.tagName === "DIV" &&
            this.utils.isEmpty(blockHtml) &&
            !$(blockElem).hasClass("redactor-editor")
          ) {
        ...
        insertAfterLastElement: function (element) {
          ...
          if (this.opts.linebreaks) {
            ...
            if (
              this.utils.getOuterHtml(last) != this.utils.getOuterHtml(element)
            )
              return;
        ...
        removeEmptyListInTable: function (e) {
          ...
          if (
            td.length !== 0 &&
            $current.closest("li", this.$editor[0]) &&
    ...
    keyup: function () {
      return {
        init: function (e) {
          ...
          if (
            !this.opts.linebreaks &&
            this.keyup.current.nodeType === 3 &&
            this.keyup.current.length <= 1 &&
            (this.keyup.parent === false || this.keyup.parent.tagName == "BODY")
          ) {
          ...
          if (
            ...
            this.keyup.current.tagName === "DIV"
          ) {
          ...
          if (
            !this.opts.linebreaks &&
            $(this.keyup.parent).hasClass("redactor-invisible-space") &&
            ($parent === false || $parent[0].tagName == "BODY")
          ) {
          ...
          if (key === this.keyCode.DELETE || key === this.keyCode.BACKSPACE) {
            ...
            if (
              ...
              this.keyup.current &&
              this.keyup.current.tagName == "DIV" &&
              this.utils.isEmpty(this.keyup.current.innerHTML)
            ) {
    ...
    lang: function () {
      return {
        ...
        get: function (name) {
          return typeof this.opts.curLang[name] != "undefined"
    ...
    line: function () {
      return {
        ...
        isExceptLastOrFirst: function (blocks) {
          ...
          last =
            typeof last == "undefined" ? first : last.tagName.toLowerCase();
    ...
    link: function () {
      return {
        show: function (e) {
          ...
          var buttonText = !this.observe.isCurrent("a")
        ...
        cleanUrl: function () {
          ...
          if (typeof this.link.url !== "undefined") {
            ...
            if (!this.opts.linkProtocol) {
              var re = new RegExp(
                "^(http|ftp|https)://" + self.location.host,
                "i"
              );
        ...
        getData: function () {
          ...
          var $el = $(this.selection.getCurrent()).closest(
            "a",
            this.$editor[0]
          );
        ...
        insert: function () {
          ...
          if (
            link.search("@") != -1 &&
            /(http|ftp|https):\/\//i.test(link) === false
          ) {
          ...
          if (this.link.$node) {
            ...
            if (this.utils.browser("mozilla") && this.link.text === "") {
              ...
              if (this.utils.browser("msie")) {
                ...
                $a = $(this.selection.getCurrent()).closest(
                  "a",
                  this.$editor[0]
                );
                if (this.utils.browser("mozilla")) {
    ...
    linkify: function () {
      return {
          ...
          this.$editor
            ...
            .filter(function () {
              return (
                ...
                $.trim(this.nodeValue) != "" &&
                !$(this).parent().is("pre") &&
                (this.nodeValue.match(opts.linkify.regexps.youtube) ||
                  this.nodeValue.match(opts.linkify.regexps.vimeo) ||
                  this.nodeValue.match(opts.linkify.regexps.image) ||
                  this.nodeValue.match(opts.linkify.regexps.url))
              );
            })
            .each(function () {
              var text = $(this).text(),
              ...
              if (
                opts.convertVideoLinks &&
                (html.match(opts.linkify.regexps.youtube) ||
                  html.match(opts.linkify.regexps.vimeo))
              ) {
                html = linkify.convertVideoLinks(html);
              } else if (
                opts.convertImageLinks &&
                html.match(opts.linkify.regexps.image)
              ) {
        ...
        convertVideoLinks: function (html) {
          var iframeStart =
              '<iframe class="redactor-linkify-object" width="500" height="281" src="',
    ...
    list: function () {
      return {
        ...
        insert: function (cmd) {
          ...
          if (this.utils.isEmpty($list.find("li").text())) {
            ...
            if (
              ...
              this.utils.browser("mozilla") &&
              $children.size() == 2 &&
              this.utils.isEmpty($children.eq(1).text())
            ) {
          ...
          if ($list.length) {
            ...
            if (
              this.utils.isRedactorParent($listParent) &&
              $listParent[0].tagName != "LI" &&
              this.utils.isBlock($listParent[0])
            ) {
        ...
        remove: function (cmd, $list) {
          ...
          if (
            !this.opts.linebreaks &&
            $current.closest("li, th, td", this.$editor[0]).length === 0
          ) {
            document.execCommand("formatblock", false, "p");
            this.$editor
          ...
          var $table = $(this.selection.getCurrent()).closest(
            "table",
            this.$editor[0]
          );
          var $prev = $table.prev();
      ...
      return {
        ...
        loadTemplates: function () {
          this.opts.modal = {
            imageEdit:
              ...
              this.lang.get("link") +
              "</label>" +
              '<input type="text" id="redactor-image-link" class="redactor-image-link-option" aria-label="' +
              this.lang.get("link") +
              '" />' +
              '<label class="redactor-image-link-option"><input type="checkbox" id="redactor-image-link-blank" aria-label="' +
              this.lang.get("link_new_tab") +
              '"> ' +
              this.lang.get("link_new_tab") +
              "</label>" +
              '<label class="redactor-image-position-option">' +
              this.lang.get("image_position") +
              "</label>" +
              '<select class="redactor-image-position-option" id="redactor-image-align" aria-label="' +
              this.lang.get("image_position") +
              '">' +
              '<option value="none">' +
              this.lang.get("none") +
            ...
            file:
              ...
              "</label>" +
              '<input type="text" id="redactor-filename" aria-label="' +
              this.lang.get("filename") +
              '" /><br><br>' +
            ...
            link:
              ...
              this.lang.get("text") +
              "</label>" +
              '<input type="text" id="redactor-link-url-text" aria-label="' +
              this.lang.get("text") +
              '" />' +
              '<label><input type="checkbox" id="redactor-link-blank"> ' +
              this.lang.get("link_new_tab") +
              "</label>" +
              "</section>",
          };
        ...
        show: function () {
          ...
          this.$modal
            ...
            .on("keydown.redactor-modal", $.proxy(this.modal.setEnter, this));
        },
        ...
        createButton: function (label, className) {
          var button = $("<button>")
            ...
            .addClass("redactor-modal-" + className + "-btn")
            .html(label);
          this.$modalFooter.append(button);
        ...
        close: function (e) {
          if (e) {
            if (
              !$(e.target).hasClass("redactor-modal-close-btn") &&
    ...
    observe: function () {
      return {
          ...
          $.each(
            ...
            $.proxy(function (key, value) {
              var observe = value.observe,
                ...
                $item = value.item,
                inValues =
                  typeof observe["in"] != "undefined" ? observe["in"] : false,
                outValues =
                  typeof observe["out"] != "undefined" ? observe["out"] : false;
        ...
        setDropdownProperties: function (
          $item,
          addProperties,
          deleteProperties
        ) {
          if (
            deleteProperties &&
            typeof deleteProperties["attr"] != "undefined"
          ) {
        ...
        buttons: function (e, btnName) {
          ...
          $.each(
            ...
            $.proxy(function (key, value) {
              ...
              if (
                parentEl.length !== 0 &&
                !this.utils.isRedactorParent(parentEl)
              )
                return;
              if (!this.utils.isRedactorParent(currentEl)) return;
              if (
                parentEl.length !== 0 ||
                currentEl.closest(key, this.$editor[0]).length !== 0
              ) {
          ...
          $(document).on(
            ...
            $.proxy(function (e) {
              ...
              if (
                ...
                this.observe.image =
                  this.observe.image && this.observe.image == e.target
                    ? false
                    : e.target;
              }
            }, this)
        ...
        showTooltip: function (e) {
          ...
          var aEdit = $('<a href="#" />')
            ...
            .on("click", $.proxy(this.link.show, this))
            .addClass("redactor-link-tooltip-action");
          var aUnlink = $('<a href="#" />')
        ...
        closeTooltip: function (e) {
          ...
          if (
            ...
            (target.tagName === "A" && this.utils.isRedactorParent(target)) ||
    ...
    paste: function () {
      return {
        ...
        insert: function (html) {
          ...
          // clean
          html = this.utils.isSelectAll()
            ? this.clean.onPaste(html, false)
            : this.clean.onPaste(html);
      ...
      return {
        enable: function () {
          ...
          this.$editor.on(
            ...
            $.proxy(this.placeholder.toggle, this)
          );
        },
        toggle: function () {
          setTimeout(
            $.proxy(function () {
              var func = this.utils.isEmpty(this.$editor.html(), false)
                ? "addClass"
                : "removeClass";
        ...
        is: function () {
          if (this.opts.placeholder) {
            ...
            return !(
              typeof this.$element.attr("placeholder") == "undefined" ||
    ...
    selection: function () {
      return {
        ...
        getInlines: function (nodes, tags) {
          ...
          var inlines = [];
          nodes =
            typeof nodes == "undefined" || nodes === false
              ? this.selection.getNodes()
              : nodes;
        ...
        getBlocks: function (nodes) {
          ...
          var blocks = [];
          nodes =
            typeof nodes == "undefined" ? this.selection.getNodes() : nodes;
        ...
        getNodes: function () {
          ...
          this.$editor.find("*").each(function () {
            if (this == startNode) {
              ...
              if (
                ...
                self.utils.isRedactorParent(parent[0])
              ) {
                nodes.push(parent[0]);
              }
          ...
          for (var i = 0; i < len; i++) {
            if (
              nodes[i].id != "nodes-marker-1" &&
              nodes[i].id != "nodes-marker-2"
            ) {
    ...
    tabifier: function () {
      return {
        ...
        placeTag: function (tag, out) {
          ...
          if (
            tag.match(this.tabifier.lineAfter) ||
            tag.match(this.tabifier.newLevel)
          ) {
            out = out.replace(/ *$/, "");
            //out += '\n';
          }
            ...
            $.proxy(function (n, s) {
              ...
              for (var i = 0; i < len; i++) {
                if (
                  ...
                  style.match(
                    new RegExp(
                      "^" + this.tidy.settings.replaceStyles[i][0],
                      "i"
                    )
                  )
                ) {
        ...
        removeAttr: function () {
          ...
          if (
            ...
            this.tidy.$div.find("*").each(
              $.proxy(function (n, s) {
                ...
                var attributesRemove = this.tidy.removeAttrGetRemoves(
                  pos,
                  allowedAttrData,
                  $el
                );
          ...
          if (this.tidy.settings.removeAttr) {
            ...
            for (var i = 0; i < len; i++) {
              ...
              this.tidy.$div
                .find(this.tidy.settings.removeAttr[i][0])
                .removeAttr(attrs);
            }
          }
        },
    ...
    toolbar: function () {
      return {
        ...
        loadButtons: function () {
          $.each(
            ...
            $.proxy(function (i, btnName) {
              ...
              this.$toolbar.append(
                $("<li>").append(this.button.build(btnName, btnObject))
              );
            }, this)
          );
        },
        ...
        setFixed: function () {
          ...
          $(this.opts.toolbarFixedTarget).on(
            "scroll.redactor." + this.uuid,
            $.proxy(this.toolbar.observeScroll, this)
          );
        },
      ...
      return {
        ...
        sendData: function (formData, e) {
          ...
          if (this.upload.type == "image") {
            formData = this.upload.getHiddenFields(
    ...
    utils: function () {
      return {
        ...
        removeEmpty: function (i, s) {
          ...
          $s.find(".redactor-invisible-space")
            .removeAttr("style")
            .removeAttr("class");
        ...
        restoreScroll: function () {
          if (
            typeof this.saveScroll === "undefined" &&
            typeof this.saveBodyScroll === "undefined"
          )
            return;
        ...
        isRedactorParent: function (el) {
          ...
          if (
            $(el).parents(".redactor-editor").length === 0 ||
            $(el).hasClass("redactor-editor")
          ) {
            return false;
          }
        ...
        browser: function (browser) {
          ...
          if (browser == "safari")
            return typeof match[3] != "undefined"
              ? match[3] == "safari"
              : false;
          if (browser == "version") return match[2];
          if (browser == "webkit")
            return (
              match[1] == "chrome" || match[1] == "opr" || match[1] == "webkit"
            );
